...
export function getCurrentTime(): Date {
  ...
  const offsetCentralStandardTime = 5; // Italy is in Central European Summer Time (UTC+2), but you might need to adjust this based on Daylight Saving Time
  now.setHours(now.getUTCHours() - offsetCentralStandardTime);
